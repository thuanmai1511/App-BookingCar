...
const myCar = ({navigation,route})=> {
    ...
    return(
        ...
        <View style={{ flexDirection: 'row', backgroundColor:'black', alignItems:"center", marginTop: 30, padding: 20}}>
               ...
               <View style={{borderColor:'#e8eaef',width:"95%", height:480, backgroundColor:"#ffffff",borderTopLeftRadius:5,borderTopRightRadius:5,borderBottomEndRadius:5,borderBottomLeftRadius: 5,shadowColor: "#000",
   shadowOffset: {
       width: 0,
       height: 3,
   },
   ...
   elevation: 7,}}>
                <View style={{flexDirection:'row'}}>
                        <View style={{justifyContent:'center', alignContent:'center',height:480,backgroundColor:'#00a550',width:50}}>
                ...
                <View>
                  ...
                  <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center',marginTop:15,marginLeft:15}}>
                      <View style={{flexDirection:'column'}}>
                        <Text style={{fontSize:14,color:'#00a550',marginLeft:20}}>Từ ngày</Text>
                        <Text style={{fontSize:19,marginTop:5}}>{it.dateStart}</Text>
                      </View>
                      <Entypo name="arrow-long-right" size={30} color="#00a550" style={{marginHorizontal:20}} />
                      <View style={{flexDirection:'column'}}>
                        <Text style={{fontSize:14,color:'#00a550',marginLeft:20}}>Đến ngày</Text>
                        <Text style={{fontSize:19,marginTop:5}}>{it.dateEnd}</Text>
                      </View>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                        <Text style={{fontWeight:'bold', marginLeft:10,width:100,marginTop:10}}>Họ tên</Text>
                    ...
                    <View style={{flexDirection:'row',marginTop:5}}>
                        <Text style={{fontWeight:'bold', marginLeft:10,width:100}}>Liên lạc</Text>
                   ...
                   
                    {
                            it.feeExpress != 0 ? 
                            <View style={{flexDirection:'row',marginTop:5}}>
                                <Text style={{fontWeight:'bold',  marginLeft:10,width:100}}>Địa chỉ</Text>
                    ...
                    <View style={{flexDirection:'row',marginTop:5}}>
                        <Text style={{fontWeight:'bold',  marginLeft:10,width:100}}>Giá thuê</Text>
                    ...
                    <View style={{flexDirection:'row',marginTop:5}}>
                        <Text style={{fontWeight:'bold',  marginLeft:10,width:100}}>Giao xe</Text>
                  
                        {it.feeExpress != 0 ? <Text>Có hỗ trợ</Text> : <Text>Không hỗ trợ</Text>}
                    ...
                    <View style={{flexDirection:'row',marginTop:5}}>
                        <Text style={{fontWeight:'bold', marginLeft:10,width:100}}>Tổng cộng</Text>
                    ...
                    <View style={{flexDirection:'row',marginTop:5}}>
                        <Text style={{fontWeight:'bold',marginLeft:10,width:100}}>Trạng thái</Text>
